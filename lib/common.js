...
PaymentProtocol.PAYMENT_REQUEST_CONTENT_TYPE = 'application/terracoin-paymentrequest';
PaymentProtocol.PAYMENT_CONTENT_TYPE = 'application/terraccoin-payment';
PaymentProtocol.PAYMENT_ACK_CONTENT_TYPE = 'application/terracoin-paymentack';
...
function magicHash(str) {
  var magicBytes = new Buffer('DarkCoin Signed Message:\n');
